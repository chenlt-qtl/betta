<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="熟悉度" prop="familiarity">
        <el-input
          v-model="queryParams.familiarity"
          placeholder="请输入熟悉度"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="熟悉度" prop="familiarity">
          <el-input v-model="form.familiarity" placeholder="请输入熟悉度，越高越熟悉，0为最低" />
        </el-form-item>
      </el-form>
...
<script>
import { listScore, getScore, delScore, addScore, updateScore } from "@/api/eng/score";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除用户成绩编号为"' + ids + '"的数据项？').then(function() {
        return delScore(ids);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('eng/score/export', {
        ...this.queryParams
