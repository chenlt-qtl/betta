<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="wordList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="音频位置" align="center" prop="phAnMp3" />
...
<script>
import { listWord, getWordById, delWord, addWord, updateWord } from "@/api/eng/word";
