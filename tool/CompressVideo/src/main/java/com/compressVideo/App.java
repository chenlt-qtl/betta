...
public class App {
    ...
    private static final List<String> PATHS = List.of("E:\\学习\\python");
    //转换后存放位置
    //String targetPath = path+ "\\after\\";
    public static final List<String> TARGET_PATHS = List.of("E:\\学习\\python" +
            "1");
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("剩余内存: " + freeMemory + "MB");
        System.out.println("=========================================");
        long time = System.currentTimeMillis();
        FAIL_LIST.clear();
        
        // 优化线程池配置：减少并发数以降低内存压力
        int corePoolSize = Math.max(4, Runtime.getRuntime().availableProcessors() / 2);
        int maximumPoolSize = corePoolSize + 6;
